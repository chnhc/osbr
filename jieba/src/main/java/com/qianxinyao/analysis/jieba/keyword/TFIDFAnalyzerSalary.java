 ...
 */
public class TFIDFAnalyzerSalary
{
	...
	public List<Keyword> analyze(String content,int topN){
		...
		if(idfMap==null) {
			idfMap=new HashMap<>();
			loadIDFMap(idfMap, this.getClass().getResourceAsStream("/idf_salary.txt"));
		}
	...
	private Map<String, Double> getTF(String content) {
		...
		String path1 =  "D:/workspace/jiebafile/jieba_salary.dict";
		loadDict(path1);
	...
	public static void main(String[] args)
	{
		...
		int topN=15;
		TFIDFAnalyzerSalary tfidfAnalyzer=new TFIDFAnalyzerSalary();
