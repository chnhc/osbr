...
import com.kkIntegration.common.json.MyOAuth2AccessTokenJackson1Deserializer;
import com.kkIntegration.common.json.MyOAuth2AccessTokenJackson1Serializer;
import com.kkIntegration.common.json.MyOAuth2AccessTokenJackson2Deserializer;
import com.kkIntegration.common.json.MyOAuth2AccessTokenJackson2Serializer;
...
@org.codehaus.jackson.map.annotate.JsonSerialize(using = MyOAuth2AccessTokenJackson1Serializer.class)
@org.codehaus.jackson.map.annotate.JsonDeserialize(using = MyOAuth2AccessTokenJackson1Deserializer.class)
@com.fasterxml.jackson.databind.annotation.JsonSerialize(using = MyOAuth2AccessTokenJackson2Serializer.class)
@com.fasterxml.jackson.databind.annotation.JsonDeserialize(using = MyOAuth2AccessTokenJackson2Deserializer.class)
public class MyOAuth2AccessToken implements Serializable, OAuth2AccessToken {
     ...
     */
    public MyOAuth2AccessToken(String value, String bearerType) {
        this.tokenEntity.setTokenType(bearerType);
    ...
    public boolean isAutoRefresh() {
        return tokenEntity.isAutoRefresh();
    }

    public void setAutoRefresh(boolean autoRefresh) {
        tokenEntity.setAutoRefresh(autoRefresh);
    }

    public void autoRefresh() {
        tokenEntity.setAutoRefresh(true);
    }
}
