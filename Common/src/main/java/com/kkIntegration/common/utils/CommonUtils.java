...
public final class CommonUtils {
     ...
     * 判断数组里面是否存在该值
     */
    public static boolean isArrayContain(Object[] arr, Object val) {
        if (val instanceof Integer && arr instanceof Integer[]) {
            for (Object i : arr) {
                if ((Integer) i == (Integer) val) {
                    return true;
                }
            }
        } else if (val instanceof String && arr instanceof String[]) {
            for (Object i : arr) {
                if (((String) i).equals((String) val)) {
                    return true;
                }
            }
        } else if (val instanceof Boolean && arr instanceof Boolean[]) {
            for (Object i : arr) {
                if ((Boolean) i == (Boolean) val) {
                    return true;
                }
            }
        }
     ...
     * 判断数组里面是否存在该值 字符串
     */
    public static boolean isStringArrayContain(String[] arr, String val) {
     ...
     * 判断数组里面是否存在该值 整数值
     */
    public static boolean isIntegerArrayContain(Integer[] arr, Integer val) {
     ...
     * 判断数组里面是否存在该值 bool
     */
    public static boolean isBooleanArrayContain(Boolean[] arr, Boolean val) {
